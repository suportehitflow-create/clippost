...
/**
 * useHorizontalFisheyeDock
 * Bencho / macOS Fisheye Physics Hook for Horizontal Bottom Dock:
 * Sets --d (item distance from cursor X) and --f (raised cosine factor)
 ...
 */
export function useHorizontalFisheyeDock(reach: number = 2.8) {
  ...
  const onMouseMove = useCallback((e: React.MouseEvent) => {
    ...
    rafId.current = requestAnimationFrame(() => {
      itemRefs.current.forEach((item) => {
        ...
        const d = Math.abs(mouseX - centerX) / w
